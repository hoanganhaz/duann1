<div class="row">
    ...
    <div class="row frmcontent">
        ...
        <div class="row mb-10 frmdsloai">
            <table style="margin-left: 20px;">
                ...
                foreach ($listdanhmuc as $danhmuc) {
                    ...
                    <td style="text-align:center;border: 1px solid gray;"><img style="width:100px;height:100px" src="../../../public/img/' . $img . '" alt=""></td>
        ...
        <div class=" mb-10">
            <br>
            <a href="index.php?act=adddm"><input style="border-radius:50px;padding:4px 10px;background-color:#198754;border:1px solid #198754;color:white;" type="button" value="nhập thêm"></a>
        </div>
