<div class="row">
    ...
    <div class="frmcontent">
        ...
        <div class=" m-10 ">
            ...
            <table class="formloai ">
                ...
                foreach ($listsanpham as $sanpham) {
                    ...
                    <td style="border: 1px solid gray;text-align:center ;"><img style="width:100px" src="../../../public/img/<?=$img?>" alt=""></td>
        ...
        <div class="">
            <a href="index.php?act=addsp"><input style="border-radius:50px;padding:2px 10px;background-color:#198754;border:1px solid #198754;color:white;" type="button" value="nhập thêm"></a>
        </div>
